...
Java_com_ywl5320_wllivepusher_push_WlPushVideo_initPush(JNIEnv *env, jobject instance,
                                                        jstring pushUrl_) {
...
JNIEXPORT void JNICALL
Java_com_ywl5320_wllivepusher_push_WlPushVideo_pushSPSPPS(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_ywl5320_wllivepusher_push_WlPushVideo_pushVideoData(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_ywl5320_wllivepusher_push_WlPushVideo_pushAudioData(JNIEnv *env, jobject instance,
...
JNIEXPORT void JNICALL
Java_com_ywl5320_wllivepusher_push_WlPushVideo_pushStop(JNIEnv *env, jobject instance) {
