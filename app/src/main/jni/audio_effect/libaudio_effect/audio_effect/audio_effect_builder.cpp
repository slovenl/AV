...
AudioEffect* AudioEffectBuilder::buildAudioEffect(jobject audioEffect, JNIEnv* env) {
	...
	jmethodID audioEffect_getReverbParam = env->GetMethodID(cls_AudioEffect, "getReverbParam", "()Lcom/changba/songstudio/audioeffect/SOXReverbParam;");
	jmethodID audioEffect_getEqualizerParam = env->GetMethodID(cls_AudioEffect, "getEqualizerParam", "()Lcom/changba/songstudio/audioeffect/SOXEqualizerParam;");
	jmethodID audioEffect_getCompressorParam = env->GetMethodID(cls_AudioEffect, "getCompressorParam", "()Lcom/changba/songstudio/audioeffect/SOXCompressorParam;");
	...
	jmethodID audioEffect_getAudioInfo = env->GetMethodID(cls_AudioEffect, "getAudioInfo", "()Lcom/changba/songstudio/audioeffect/AudioInfo;");
	jmethodID audioEffect_getOutputGainParam = env->GetMethodID(cls_AudioEffect, "getOutputGainParam", "()Lcom/changba/songstudio/audioeffect/OutputGainParam;");
