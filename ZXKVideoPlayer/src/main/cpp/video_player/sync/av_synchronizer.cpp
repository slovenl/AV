...
bool AVSynchronizer::init(DecoderRequestHeader *requestHeader, JavaVM *g_jvm, jobject obj, float minBufferedDuration,
...
//			LOGI("onCompletion...");
        ...
        bool isBufferedDurationIncreasedToMin = leftVideoFrames >= int(minBufferedDuration * getVideoFPS()) &&
