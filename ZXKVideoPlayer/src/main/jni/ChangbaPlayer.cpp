...
JNIEXPORT jboolean JNICALL Java_com_changba_songstudio_video_player_ChangbaPlayer_prepare(
        JNIEnv *env, jobject obj, jstring videoMergeFilePathParam, jintArray max_analyze_duration,
        jint size, jint probesize, jboolean fpsProbeSizeConfigured, jfloat minBufferedDuration,
    ...
    jboolean initCode = videoPlayerController->init(videoMergeFilePath, g_jvm, g_obj,
                                                    max_analyze_duration_params,
                                                    size, probesize, fpsProbeSizeConfigured,
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_pause(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_play(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_stop(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
...
Java_com_changba_songstudio_video_player_ChangbaPlayer_getBufferedProgress(JNIEnv *env,
                                                                           jobject obj) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT jfloat JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_getPlayProgress(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_resetRenderSize(JNIEnv *env, jobject obj,
                                                                       jint left, jint top,
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_seekToPosition(JNIEnv *env, jobject obj,
                                                                      jfloat position) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_seekCurrent(JNIEnv *env, jobject obj,
                                                                   jfloat position) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_beforeSeekCurrent(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
...
JNIEXPORT void JNICALL
Java_com_changba_songstudio_video_player_ChangbaPlayer_afterSeekCurrent(JNIEnv *env, jobject obj) {
    if (NULL != videoPlayerController) {
