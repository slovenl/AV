...
JNIEXPORT void JNICALL Java_com_changba_songstudio_recorder_NativeRecordProcessor_setAudioEffect(JNIEnv * env, jobject obj, jint index, jobject audioEffect){
	if (handles[index] != 0) {
